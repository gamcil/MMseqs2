...
std::vector<Command> baseCommands = {
        ...
        {"createtaxdb",          createtaxdb,          &par.createtaxdb,          COMMAND_TAXONOMY,
                ...
                CITATION_TAXONOMY, {{"sequenceDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                                           {"tmpDir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory }}},
        {"createcontextdb", createcontextdb, &par.createcontextdb, COMMAND_DATABASE_CREATION,
                "Create genomic context database from feature table",
                "# Create a genomic context database from a feature table\n"
                "# Feature columns: target_sequence_id, feature_id, scaffold, start, end, strand\n"
                "# Coordinates are inclusive; strand accepts 1, -1, +, or -\n"
                "mmseqs createcontextdb targetDB features.tsv contextDB tmp --context-window 5\n",
                "Cameron L.M. Gilchrist <gamcil@snu.ac.kr>",
                "<i:sequenceDB> <i:featureTable> <o:contextDB> <tmpDir>",
                CITATION_MMSEQS2, {{"sequenceDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::NEED_LOOKUP, &DbValidator::sequenceDb },
                                   ...
                                   {"contextDB", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::contextDb },
                                   {"tmpDir", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::directory }}},
        {"createcontextresolve", createcontextresolve, &par.createcontextresolve, COMMAND_DATABASE_CREATION | COMMAND_EXPERT | COMMAND_HIDDEN,
                ...
                CITATION_MMSEQS2, {{"lookupTsv", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                   {"featureTable", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::flatfile },
                                   {"resolvedFeatureTable", DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::flatfile }}},
        {"createcontextcontexts", createcontextcontexts, &par.createcontextcontexts, COMMAND_DATABASE_CREATION | COMMAND_EXPERT | COMMAND_HIDDEN,
                "Create inline genomic context rows",
                NULL,
                "Cameron L.M. Gilchrist <gamcil@snu.ac.kr>",
                "<i:resolvedFeatureTable> <o:contextRows>",
        ...
        {"createcontextdbcore", createcontextdbcore, &par.createcontextdbcore, COMMAND_DATABASE_CREATION | COMMAND_EXPERT | COMMAND_HIDDEN,
                "Create genomic context database from inline context rows",
                NULL,
                "Cameron L.M. Gilchrist <gamcil@snu.ac.kr>",
...
//                "Low. complex regions are masked as lower case characters. The remaining regions are printed as upper case characters.",
        ...
        {"result2dnamsa",           result2dnamsa,           &par.result2dnamsa,           COMMAND_RESULT,
                ...
                CITATION_MMSEQS2,{{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                         ...
                                         {"resultDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::resultDb },
                                         {"msaDB",    DbType::ACCESS_MODE_OUTPUT, DbType::NEED_DATA, &DbValidator::msaDb }}},
        {"result2context",  result2context,  &par.verbandcompression, COMMAND_RESULT,
                "Expand alignment results with target genomic contexts",
                ...
                "mmseqs result2context queryDB targetDB resultDB contextDB outputDB\n",
                "Cameron L.M. Gilchrist <gamcil@snu.ac.kr>",
                "<i:queryDB> <i:targetDB> <i:alignmentDB> <i:contextDB> <o:resultDB>",
                CITATION_MMSEQS2, {{"queryDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::sequenceDb },
                                          {"targetDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA|DbType::NEED_LOOKUP, &DbValidator::sequenceDb },
                                          {"alignmentDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::alignmentDb },
                                          {"contextDB", DbType::ACCESS_MODE_INPUT, DbType::NEED_DATA, &DbValidator::contextDb },
